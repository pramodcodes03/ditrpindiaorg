...
class Snpagination extends CI_Pagination {
     ...
     * @return  string
     */
    public function create_sn_linking()
    {
...
// !!!!!!!! END EDITION !!!!!!!!!!
        ...
        if ($this->next_link !== FALSE && $this->cur_page < $num_pages)
        {
            ...
            $output .= $this->next_tag_open.'<a href="'.$this->base_url.$this->prefix.$i.$this->suffix.'"'.$attributes
                .$this->_attr_rel('next').' class="push_button orange" id="submits" onclick="saveNnext('.$this->cur_page.'), submitFrm(1)">'.$this->next_link.'</a>'.$this->next_tag_close;
...
// !!!!!!!! START EDITION !!!!!!!!!!
        elseif ($this->display_next_link && $this->cur_page >= $num_pages) {
            ...
            $output .= $this->next_tag_open.'<a href class="push_button orange" id="submits" onclick="saveNnext('.$this->cur_page.'), submitFrm(1)">'.$this->next_link.'</a>'.$this->next_tag_close;
