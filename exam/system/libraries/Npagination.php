...
class Npagination extends CI_Pagination {
     ...
     * @return  string
     */
    public function create_linkings()
    {
...
// !!!!!!!! END EDITION !!!!!!!!!!
                ...
                if ($i >= $base_page)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            $output .= $this->num_tag_open.'<span="'.$this->base_url.$append.'"'.$attributes.$this->_attr_rel('start').'>'
                                .$loop.'</span>'.$this->num_tag_close;
                        }
                    }
                }
            }
        ...
        if ($this->next_link !== FALSE && $this->cur_page < $num_pages)
        {
            ...
            $output .= $this->next_tag_open.'<a href="'.$this->base_url.$this->prefix.$i.$this->suffix.'"'.$attributes
                .$this->_attr_rel('next').' class="btn btn-default" style="width:100px">'.$this->next_link.'</a>'.$this->next_tag_close;
        } 
// !!!!!!!! START EDITION !!!!!!!!!!
        elseif ($this->display_next_link && $this->cur_page >= $num_pages) {
            $output .= $this->next_tag_open.'<span class="btn btn-default" style="width:100px">'.$this->next_link.'</span>'.$this->next_tag_close;
        }
// !!!!!!!! END EDITION !!!!!!!!!!
