...
#seconds {
	...
	/*
	background: #ffffff; 
	background: -moz-linear-gradient(top, #F7F7F7 38%, #cccccc 100%); 
	background: -webkit-gradient(linear, left top, left bottom, color-stop(38%, #F7F7F7), color-stop(100%, #cccccc));
	background: -webkit-linear-gradient(top, #F7F7F7 38%, #cccccc 100%);
	background: -o-linear-gradient(top, #F7F7F7 38%, #cccccc 100%); 
	background: -ms-linear-gradient(top, #F7F7F7 38%, #cccccc 100%); 
	background: linear-gradient(to bottom, #F7F7F7 38%, #cccccc 100%); */
 filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#F7F7F7', endColorstr='#cccccc', GradientType=0 ); /* IE6-9 */
}
input[type=radio] {
	display:none;
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
            ...
            <ul class="nav side-menu">
              <li style="padding:10px; color:#73879C; font-size:14px ">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="dashboard_graph">
            <div class="row x_title">
              <div class="col-md-12"> 
                <div class="col-md-6">
                <h1 style="text-shadow: 1px 1px 1px #aba6a6, 3px 3px 5px #ccc; color:#254E86; margin-top:15px; float:left;font-size: 25px;"><strong>Online Exam</strong></h1>
                </div>
              </div>
            </div>
                  ...
                  <div>
                    <div>
					 ...
					 <div class="col-sm-2"><span class="btn btn-primary next push_button orange" onClick="saveNnext(window.location.hash.replace('#', '')), saveForward(window.location.hash.replace('#', ''))">SAVE & NEXT</span></div>
					  ...
					  <div class="col-sm-2"><span class="btn btn-success push_button green" onclick="examOver(window.location.hash.replace('#', ''))">END EXAM</span></div>
					  </p>
                    </div>
                  </div> 
              </div>
            ...
            <div class="left_pagi">
			  ...
			  <div class="col-md-12">
					<div class="row col-md-12">
						<div style="padding: 5px; text-align: center; margin: 20px 20px;font-size: 18px;
    color: #000;"> <span class="btn btn-default" style="background:#13803b !important;padding:20px"></span>&nbsp;Appeared <span class="btn btn-default" style="background:#fb430b !important;padding:20px" ></span>&nbsp;Not Appeared  </div>
					</div>
				</div>
            </div>
				</div>
      ...
      <footer>
       <!-- <div class="">
          <p style="text-align:center !important"> <span class="lead" style="font-size:15px; margin-top:50px"><img src="<?=base_url()?>assets/logo/icon.png" width="30px"> <strong>ALL INDIA COUNCIL FOR PROFESSIONAL EXCELLENCE</strong></span> </p>
        </div>
        <div class="clearfix"></div>-->
      </footer>
        ...
        function pad(val)
        {
            ...
            else
            {
				...
				{ 
					...
					document.getElementById('sess_over').action = "<?=base_url()?>home/sess_overs";
...
function examOver(uri)
{
	...
	if (r==true)
	{
		...
		//alert(frm);
		document.getElementById('exam_Over').action = "<?=base_url()?>home/exam_overs";
...
function saveForward(uri)
{
	...
	var url = "<?=base_url()?>home/save_n_next";
