...
/* __FILE__ etc.; https://php.net/manual/en/reserved.php */
span.php-compile-time-constant {
  color: #776088;
  font-weight: bold;
}

/* output of get_defined_constants(). Differs from https://php.net/manual/en/reserved.constants.php */
span.php-predefined-constant {
  color: darkgreen;
  font-weight: bold;
}

/* PHP reserved "language constructs"... echo() etc.; https://php.net/manual/en/reserved.php */
...
/* PHP predefined classes: PDO, Exception etc.; output of get_declared_classes() and different from https://php.net/manual/en/reserved.classes.php */
