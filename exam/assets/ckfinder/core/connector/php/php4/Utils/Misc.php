...
class CKFinder_Connector_Utils_Misc
{
    ...
    /**
     * @link https://pl.php.net/manual/en/function.imagecopyresampled.php
    ...
    /**
     * @link https://pl.php.net/manual/pl/function.imagecreatefromjpeg.php
     ...
     * @link https://pl.php.net/manual/en/function.ini-get.php
     *
     * @static
     * @access public
     * @param string $val
    ...
    */
    ...
    /**
    * Source: https://pl.php.net/imagecreate
