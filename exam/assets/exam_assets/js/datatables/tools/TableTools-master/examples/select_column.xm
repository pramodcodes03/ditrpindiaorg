...
In this case, the row selector is attached to the cells in the first column of the table, and [Font Awesome](https://fortawesome.github.io/Font-Awesome) is used to display a checkbox indicating the selection state of the row, in addition to the row background colouring.
