...
Have a look at the plugin Web site, https://keith-wood.name/countdown.html, for demonstrations of its abilities.

For documentation on the functionality see https://keith-wood.name/countdownRef.html.
