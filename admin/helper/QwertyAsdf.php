	...
	switch($user_role)
	{
		...
		case(2):
			...
			{	
				...
				/* Website Management */		
				//  case('studentEnquiry'):
				// 	include('include/pages/student/list_student.php');
				// 	break;
			 	//	case('studentAdmission'):
				// 	include('include/pages/student/list_student_admission.php');
				// 	break;
				
				//  case('listCourse'):					
				// 	include('include/pages/courses/list_courses.php');
				// 	break;
				//  case('addCourse'):					
				// 	include('include/pages/courses/add_course.php');
				// 	break;
				//  case('updateCourse'):					
				// 	include('include/pages/courses/update_course.php');
				// 	break;		
