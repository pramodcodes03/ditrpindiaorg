    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="courier-wallet">Wallet</a></li>
...
udf2 ->gst*/
                ...
                ?>
                  ...
                  <div class="alert alert-danger alert-dismissible" id="messages">
                    ...
                    <a href="courier-pay-online" class="btn btn-link">Click to Try Again</a>
