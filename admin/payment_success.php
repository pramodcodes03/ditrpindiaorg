                           ...
                           if ($res) {
                              if ($status == 'success') {
                                 ...
                                 if ($res && $res->num_rows > 0) {
                                    ...
                                    $updSql = "UPDATE wallet SET TOTAL_BALANCE = TOTAL_BALANCE + $udf1,  UPDATED_BY='$user_name', UPDATED_ON=NOW(), UPDATED_ON_IP='$ip_address' WHERE WALLET_ID='$WALLET_ID'";
