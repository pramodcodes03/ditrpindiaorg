 		...
 		<div class="card">
 			<div class="card-body">
 				<h4 class="card-title">List Courses
 					<a href="/website_management/addCourse" class="btn btn-primary" style="float: right">Add Courses</a>
 				</h4>
 							...
 							<?php
								...
								if ($res != '') {
									...
									*/
										...
										$action = '';
										if ($db->permission('update_course'))
											$action = "<a href='/website_management/updateCourse&id=$COURSE_ID' class='btn btn-primary btn-sm' title='Edit'><i class=' fa fa-pencil'></i>Edit</a>";
