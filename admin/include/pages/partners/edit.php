...
$action = isset($_POST['edit_partners']) ? $_POST['edit_partners'] : '';
...
if ($action != '') {
  ...
  $result = $websiteManage->edit_partners($id);
  ...
  if ($success == true) {
    ...
    header('location:/website_management/managePartners');
  }
}

$res = $websiteManage->list_partners($id, '');
if ($res != '') {
  $srno = 1;
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" name="edit_partners" class="btn btn-primary mr-2" value="Submit">
            <a href="/website_management/managePartners" class="btn btn-danger mr-2" title="Cancel">Cancel</a>
          </form>
        </div>
      </div>
    </div>
