...
if ($action == 'Update Details') {
	...
	if ($success == true) {
		...
		//header('location:/website_management/settings');
...
$action = isset($_POST['update_password']) ? $_POST['update_password'] : '';

if ($action == 'Update Password') {



	$result		= $admin->update_user_pass();
			...
			<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					...
					<ul class="nav nav-tabs">
						...
						<li class="menu-buttons active"><a href="#account" data-toggle="tab">Account</a></li>

						<li class="menu-buttons"><a href="#change-password" data-toggle="tab">Change Password</a></li>
						...
						<div class="active tab-pane" id="account">
							...
							if ($profile != '') {
								...
								while ($data = $profile->fetch_assoc()) {
									...
									$USER_PHOTO = DEFAULT_USER_LOGO;

									if ($PHOTO != '')

										$USER_PHOTO = ADMIN_PHOTO_PATH . '/' . $ADMIN_ID . '/' . $PHOTO;
									...
									<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
										...
										<div class="form-group col-sm-12">
											...
											<div class="col-sm-6">
												...
												<img src="<?= $USER_PHOTO ?>" class="img img-responsive" style="height:50px; width:50px" />
										...
										<div class="form-group">
											...
											<div class="col-sm-offset-2 col-sm-10">
												...
												<input type="submit" class="btn btn-primary" name="update_admin" value="Update Details" />
							...
							<form class="form-horizontal" action="" method="post">
								...
								<div class="form-group <?= (isset($errors['currentpassword'])) ? 'has-error' : '' ?>">
									...
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" id="currentpassword" value="<?= isset($_POST['currentpassword']) ? $_POST['currentpassword'] : '' ?>" placeholder="Current Password" name="currentpassword" autocomplete="off" />
								...
								<div class="form-group <?= (isset($errors['newpassword'])) ? 'has-error' : '' ?>">
									...
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" id="newpassword" placeholder="New Password" name="newpassword" value="<?= isset($_POST['newpassword']) ? $_POST['newpassword'] : '' ?>" autocomplete="off" />

										<span class="help-block"><?= isset($errors['newpassword']) ? $errors['newpassword'] : '' ?></span>
								...
								<div class="form-group <?= (isset($errors['confpassword'])) ? 'has-error' : '' ?>">

									<label for="confpassword" class="col-sm-2 control-label">Confirm Password</label>

									<div class="col-sm-6">

										<input type="text" class="form-control" id="confpassword" placeholder="Confirm Password" name="confpassword" value="<?= isset($_POST['confpassword']) ? $_POST['confpassword'] : '' ?>" autocomplete="off" />

										<span class="help-block"><?= isset($errors['confpassword']) ? $errors['confpassword'] : '' ?></span>
