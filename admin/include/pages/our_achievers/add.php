<?php
$action = isset($_POST['add_achievers']) ? $_POST['add_achievers'] : '';
include_once('include/classes/websiteManage.class.php');
$websiteManage = new websiteManage();
if ($action != '') {
  $result = $websiteManage->add_achievers();
...
<div class="content-wrapper">
  <div class="row">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Add New Achiever</h4>
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputName1" name="course" placeholder="course" value="">
            </div>
            <div class="form-group">
              <label>Image</label>
            ...
            <input type="submit" name="add_achievers" class="btn btn-primary mr-2" value="Submit">
