...
$action = isset($_POST['edit_payment']) ? $_POST['edit_payment'] : '';
...
if ($action != '') {
  ...
  $result = $websiteManage->edit_payment($id);
  ...
  if ($success == true) {
    ...
    header('location:/website_management/managePayments');
  }
}

$res = $websiteManage->list_payment($id, '');
if ($res != '') {
  $srno = 1;
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label>Image</label>
              <input type="file" name="payment_image" class="file-upload-default">
            ...
            <input type="submit" name="edit_payment" class="btn btn-primary mr-2" value="Submit">
            <a href="/website_management/managePayments" class="btn btn-danger mr-2" title="Cancel">Cancel</a>
          </form>
        </div>
      </div>
    </div>
