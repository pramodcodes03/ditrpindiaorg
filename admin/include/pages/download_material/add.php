<?php
$action = isset($_POST['add_download_materials']) ? $_POST['add_download_materials'] : '';
include_once('include/classes/websiteManage.class.php');
$websiteManage = new websiteManage();
if ($action != '') {
  $result = $websiteManage->add_download_materials();
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" name="add_download_materials" class="btn btn-primary mr-2" value="Submit">
