 						...
 						<form role="form" action="" class="form-horizontal" name="colg_detail" method="post" enctype="multipart/form-data" onsubmit="return eventFormValidation();">
 							...
 							<div class="form-group">
 								...
 								<div class="col-lg-5">
 									...
 									<a href="pages.php?pg=list_pages" class="btn btn-danger">Cancel</a>
 				...
 				<div class="box box-primary">
					...
					';
							...
							?>
 										...
 										<tr>
 											<td colspan="3">
 												<a href="/website_management/update-dynamic-page&page_id=<?= $PAGE_ID ?>&blockno=<?= $BLOCK_NO ?>" class="btn btn-primary">Edit</a>
 												<a href="/website_management/add-dynamic-page&page_id=<?= $page_id ?>&blockno=<?= $BLOCK_NO ?>&action=delete" onclick="return confirm('Are you sure?')" class="btn btn-danger">Delete</a>
 											</td>
 										</tr>
 										<?php
											echo '</table><br>';
