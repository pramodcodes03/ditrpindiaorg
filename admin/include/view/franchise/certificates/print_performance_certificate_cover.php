...
<style>
	...
	.instcode{position:absolute;top:602px;text-align:center;width:60%;font-size:18px; left:53.8%; color:#fff;}
	...
	.state{position:absolute;top:365px;text-align:center;width:60%; font-size:16px; color:#fff; left:52.0%;}
	...
	.instname{position:absolute;top:95px;text-align:center;width:100%;font-size:28px; left:2.7%; color:#da251c; font-weight:900; line-height:34px;}
		...
		$mpdf->Output('performance-certificate.pdf', 'I');
	}
} else {
