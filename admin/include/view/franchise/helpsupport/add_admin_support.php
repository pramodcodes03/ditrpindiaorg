...
$mobile = $db->get_institute_mobile($user_id);
$email  =  $db->get_institute_email($user_id);
...
if ($action != '') {
  ...
  if ($success == true) {
    ...
    header('location:page.php?page=listAdminSupport');
  }
}
?>
<div class="content-wrapper">
  <div class="row">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Add Admin Support</h4>
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <input type="hidden" value="<?= $user_id ?>" name="inst_id" />
              ...
              <div class="form-group col-md-6 <?= (isset($errors['email'])) ? 'has-error' : '' ?>">
                <label>Email</label>
                <input class="form-control" id="email" name="email" placeholder="Email" value="<?= isset($_POST['email']) ? $_POST['email'] : $email ?>" type="email" readonly>
