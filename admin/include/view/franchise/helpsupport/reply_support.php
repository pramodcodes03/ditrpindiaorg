          ...
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="form-group  col-md-12 <?= (isset($errors['reply'])) ? 'has-error' : '' ?>">
                ...
                <textarea class="form-control" id="reply" name="reply" placeholder="admin reply" type="text" rows="6"><?= isset($_POST['reply']) ? $_POST['reply'] : $ADMIN_UPDATES ?></textarea>
            ...
            <div class="box-footer text-center">
              ...
              <input type="submit" name="reply_support" class="btn btn-primary btn1" value="Reply Support" />
            </div>
