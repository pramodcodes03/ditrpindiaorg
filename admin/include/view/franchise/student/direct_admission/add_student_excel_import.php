         ...
         <div class="col-md-8">
           ...
           <div class="box box-primary">
             <div class="box-header with-border">
               ...
               <a href="page.php?page=<?= STUDENT_EXCEL_DOCUMENTS_PATH ?>/sample/student_excel_sample.xlsx" target="_blank" class="btn btn-sm btn-success pull-right"><i class="fa fa-cloud-download"></i> Download Sample CSV</a>
             </div>
             <div class="box-body">
