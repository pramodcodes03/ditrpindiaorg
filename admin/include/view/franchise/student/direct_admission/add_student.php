...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title"> Add New Student
							...
							<div class="row">
								<div class="col-md-12 row">
									<div class="form-group col-md-3 <?= (isset($errors['stud_photo'])) ? 'has-error' : '' ?>">
										...
										<label for="stud_photo">Student Photo <span class="asterisk">*</span><span> (Max file size 250 KB)</span> </label>
									...
									<div class="form-group col-md-3 <?= (isset($errors['stud_sign'])) ? 'has-error' : '' ?>">
										...
										<label for="stud_sign">Student Signature <span class="asterisk">*</span><span> (Max file size 250 KB)</span></label>
								...
								<div class="form-group col-sm-1">
									<label></label>
									<a href="page.php?page=addBatches" class="btn btn-warning" title="Cancel">Add Batch</a>
								</div>
