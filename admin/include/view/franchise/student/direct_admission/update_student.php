							...
							<div class="row">
								...
								<div class="col-md-12 row">
									...
									if (!empty($photo)) {
										...
										$disp_photo .= '<a href="page.php?page=' . $photo_path . '" target="_blank"><img id="stud_photo" src="' . $photo_path_thumb . '" class="img img-responsive thumbnail" style="width:130px; height:150px;border: 1px solid #000;" /></a>	';
										$disp_photo .= '</div>';
									}
									...
									if (!empty($sign)) {
										...
										$disp_sign .= '<a href="page.php?page=' . $sign_path . '" target="_blank"><img id="stud_sign" src="' . $sign_path_thumb . '" class="img img-responsive thumbnail" style="width:220px; height:70px;border: 1px solid #000;" /></a>	';
										$disp_sign .= '</div>';
									}
									?>
									<div class="form-group col-md-3 <?= (isset($errors['stud_photo'])) ? 'has-error' : '' ?>">
										<?= $disp_photo ?>
										<label for="stud_photo">Student Photo <span class="asterisk">*</span></label> <span> (Max file size 250 KB)</span>
									...
									<div class="form-group col-md-3 <?= (isset($errors['stud_sign'])) ? 'has-error' : '' ?>">
										<?= $disp_sign ?>
										<label for="stud_sign">Student Signature <span class="asterisk">*</span></label> <span> (Max file size 250 KB)</span>
