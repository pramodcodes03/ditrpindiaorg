							...
							<div class="row">
								<div class="col-md-12">
										...
										<div class="tab-content">
											<div class="tab-pane active" id="tab_1">
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-2">
														<div class="form-group <?= (isset($errors['mname'])) ? 'has-error' : '' ?>">
															...
															<?php
															$cert_mname = isset($_POST['cert_mname']) ? $_POST['cert_mname'] : $CERT_MNAME;
															?>
															<a href="javascript:void(0)" class="info-popup">Show on Certificate:</a>
												...
												<div class="form-group col-sm-6 <?= (isset($errors['mobile'])) ? 'has-error' : '' ?>">
													<label for="doj">Student Date Of Joining</label>
													<div class="input-group date">
														<div class="input-group-addon">
															<i class="fa fa-calendar"></i>
														</div>
														<input class="form-control pull-right" name="doj" value="<?= isset($_POST['doj']) ? $_POST['doj'] : $JOINING_FORMATED ?>" id="doj" type="text">
													</div>
													<span class="help-block"><?= (isset($errors['doj'])) ? $errors['doj'] : '' ?></span>
												</div>
											...
											<div class="tab-pane" id="tab_2">
												<div class="col-sm-12">
													...
													if (!empty($photo)) {
														...
														$photo_path = SHOW_IMG_AWS . '/student/' . $STUDENT_ID . '/' . $FILE_NAME;

														$disp_photo = '<div id="img-' . $FILE_ID . '">';
														$disp_photo .= '<a href="javascript:void(0)" onclick="deleteStudFile(' . $FILE_ID . ')"><i class="fa fa-trash"></i></a>';
														$disp_photo .= '<a href="' . $photo_path . '" target="_blank"><img src="' . $photo_path . '" class="img img-responsive thumbnail" style="height:100px;" /></a>	';
														$disp_photo .= '</div>';
													}
													?>
									...
									$photo_path_thumb  = STUDENT_DOCUMENTS_PATH.'/'.$STUDENT_ID.'/'.$FILE_NAME;*/
																		...
																		$photo_path = SHOW_IMG_AWS . '/student/' . $STUDENT_ID . '/' . $FILE_NAME;
																		$photo_path_thumb = SHOW_IMG_AWS . '/student/' . $STUDENT_ID . '/' . $FILE_NAME;
