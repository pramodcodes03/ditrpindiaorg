...
if ($resB != '') {
	...
	while ($dataB = $resB->fetch_assoc()) {
		extract($dataB);
		$typingmarksheet_image      = BACKGROUND_IMAGE_PATH . '/' . $inst_id . '/' . $typingmarksheet_image;
	}
}
...
$html .= "<div class='coursename'>TYPING COURSE</div>";
...
$marksHtml .= "<td width='25%'>1)  English Typing </td>";
...
$marksHtml .= "<tr class='highlight'>";
$marksHtml .= "<td width='25%'>2)  Hindi Typing </td>";
$marksHtml .= "<td width='3%'>44</td>";
$marksHtml .= "<td width='3%'>43</td>";
$marksHtml .= "<td width='3%'>87</td>";
$marksHtml .= '</tr>';
...
$html .= "<div class='outof_bottom'><b> Total Marks : 174 / 200</b></div>";

$html .= "<div class='total_bottom'><b>174</b></div>";
...
$html2 .= '<img src="' . $typingmarksheet_image . '" style="width:100%" />';
$html2 .= $html;
