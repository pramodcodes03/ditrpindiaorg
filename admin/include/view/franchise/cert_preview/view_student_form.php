<?php
	...
	.coursefees{position:absolute;top:800px;text-align:left;width:100%; font-size:12px; left:10%;}
	.paidfees{position:absolute;top:800px;text-align:left;width:100%; font-size:12px; left:40%;}
	.balancefees{position:absolute;top:800px;text-align:left;width:100%; font-size:12px; left:70%;}
	.batchname{position:absolute;top:860px;text-align:left;width:100%; font-size:12px; left:10%;}
	</style>';
	$html = '	
