								...
								<div class="box box-primary">
									...
									<div class="box-body row">
										<form role="form" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
											...
											<div class="form-group col-md-3 <?= (isset($errors['photo'])) ? 'has-error' : '' ?>">
											...
											<div class="form-group col-sm-4 <?= (isset($errors['code'])) ? 'has-error' : '' ?>">
												...
												<div class="col-xs-6">
													<input type="text" name="code" class="form-control" id="code" placeholder="Id Number" value="<?= isset($_POST['code']) ? $_POST['code'] : '' ?>" />
											...
											<div class="form-group col-sm-4 <?= (isset($errors['name'])) ? 'has-error' : '' ?>">
												...
												<div class="col-xs-6">
													<input type="text" name="name" class="form-control" id="name" placeholder="Name" value="<?= isset($_POST['name']) ? $_POST['name'] : '' ?>" />
											...
											<div class="form-group col-sm-4 <?= (isset($errors['designation'])) ? 'has-error' : '' ?>">
												...
												<div class="col-xs-6">
													<input type="text" name="designation" class="form-control" id="designation" placeholder="Designation" value="<?= isset($_POST['designation']) ? $_POST['designation'] : '' ?>" />
											...
											<div class="form-group col-sm-4 <?= (isset($errors['mobile'])) ? 'has-error' : '' ?>">
												...
												<div class="col-xs-6">
													<input type="text" name="mobile" class="form-control" id="mobile" placeholder="Mobile" value="<?= isset($_POST['mobile']) ? $_POST['mobile'] : '' ?>" />
											...
											<div class="form-group col-sm-4 <?= (isset($errors['email'])) ? 'has-error' : '' ?>">
												...
												<div class="col-xs-6">
													<input type="text" name="email" class="form-control" id="email" placeholder="Email Id" value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>" />
