...
if ($action != '') {
	$result = $coursetyping->update_inst_course_fees();
...
/* get course details */
$res = $coursetyping->list_added_courses_single_typing($inst_course_id);
if ($res != '') {
	$srno = 1;
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="box box-primary">
										...
										<div class="box-body">
											<input type="hidden" name="course_id" value="<?= isset($TYPING_COURSE_ID) ? $TYPING_COURSE_ID : '' ?>" />
