...
<div class="content-wrapper">
	<div class="col-lg-12 stretch-card">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title"> List Typing Courses </h4>
				<div style="margin-bottom:10px;">
					<?php if ($db->permission('view_aicpe_courses')) { ?>
					...
					<?php if ($db->permission('add_aicpe_courses')) { ?>
					...
					<?php if ($db->permission('delete_aicpe_courses')) { ?>
						<!--<a style="margin-bottom:10px;" href="page.php?page=javascript:void(0)" class="btn btn-danger" onclick="bulkDeleteInstCourse()"><i class="mdi mdi-delete"></i> Delete</a>-->
					<?php } ?>
				...
				<div class="table-responsive pt-3">
					<table id="order-listing" class="table">
						...
						<tbody>
							...
							$res = $coursetyping->list_added_courses_typing($institute_id);
							if ($res != '') {
								$srno = 1;
							...
							*/
									...
									if ($db->permission('update_aicpe_courses'))
										$action .= "<a href='page.php?page=updateCoursesTyping&id=$INSTITUTE_COURSE_ID' class='btn btn-primary table-btn' title='Edit'><i class=' mdi mdi-grease-pencil'></i></a>  ";

									if ($db->permission('delete_aicpe_courses'))
										$action .= "<a href='javascript:void(0)' onclick='deleteInstCourseTyping($INSTITUTE_COURSE_ID)' class='btn btn-danger table-btn' title='Remove'><i class=' mdi mdi-delete'></i></a>";
