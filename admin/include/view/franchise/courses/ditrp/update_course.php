...
$course = new course();
if ($action != '') {
	$result = $course->update_inst_course_fees();
...
/* get course details */
$res = $course->list_added_courses_single($inst_course_id);
if ($res != '') {
	$srno = 1;
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group <?= (isset($errors['coursefees'])) ? 'has-error' : '' ?>">
										<label for="coursefees" class="col-sm-4 control-label">Update Course Fees</label>
										<div class="col-sm-8">
											<input class="form-control" id="coursefees" name="coursefees" value="<?= isset($_POST['coursefees']) ? $_POST['coursefees'] : $INSTITUTE_COURSE_FEES ?>" type="text">
									...
									<div class="box-footer text-center">
										<a href="page.php?page=listCourses" class="btn btn-default">Cancel</a>
