 		...
 		<div class="card">
 			<div class="card-body">
 				<h4 class="card-title">List Courses With Multiple Subjects
 					<a href="page.php?page=addCourseMultiSub" class="btn btn-primary" style="float: right">Add Courses</a>
 				</h4>
 				<?php
				...
				*/
										...
										echo " <tr id='course-id" . $MULTI_SUB_COURSE_ID . "'>
											<td>$srno</td>	
											<td>$MULTI_SUB_COURSE_CODE</td>											
											<td>$MULTI_SUB_COURSE_NAME</td>
											<td>$tbl1</td>
											<td>$MULTI_SUB_COURSE_FEES</td>
											<td>$MULTI_SUB_COURSE_MRP</td>
											<td>$MULTI_SUB_MINIMUM_AMOUNT</td>
