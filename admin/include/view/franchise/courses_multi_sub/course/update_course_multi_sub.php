...
?><div class="content-wrapper">
  <div class="row">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Update Course With Multiple Subjects</h4>
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-3 form-group">
                ...
                <input type="text" class="form-control" id="exampleInputName1" name="coursefees" value="<?= isset($_POST['coursefees']) ? $_POST['coursefees'] : $MULTI_SUB_COURSE_FEES ?>">
              </div>
              <div class="col-md-3 form-group">
                <label for="exampleInputName1">Course MRP</label>
                <input type="text" class="form-control" id="exampleInputName1" name="coursemrp" value="<?= isset($_POST['coursemrp']) ? $_POST['coursemrp'] : $MULTI_SUB_COURSE_MRP ?>">
              </div>
              <div class="col-md-3 form-group">
                <label for="exampleInputName1">Minimum Fees Will Pay</label>
                <input type="text" class="form-control" id="exampleInputName1" name="minimumfees" value="<?= isset($_POST['minimumfees']) ? $_POST['minimumfees'] : $MULTI_SUB_MINIMUM_AMOUNT ?>">
              </div>
              <div class="col-md-3  form-group">
              ...
              <div class="col-md-6  form-group col-sm-12  <?= (isset($errors['fees0'])) ? 'has-error' : '' ?>">
                ...
                <div class="row">
                  ...
                  ?>
                      ...
                      <input class="col-md-7 form-control" id="subject<?= $sr ?>" name="subject<?= $sr ?>" value="<?= isset($_POST['subject' . $sr]) ? $_POST['subject' . $sr] : $COURSE_SUBJECT_NAME ?>" type="text" style="margin:2px 15px">
