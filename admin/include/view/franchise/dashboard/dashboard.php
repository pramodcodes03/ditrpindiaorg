...
<div class="content-wrapper">
  ...
  <div class="row">
    <div class="col-12 mb-4 mb-xl-0" style="background-color:yellow; padding:5px; margin-top:-20px; margin-bottom:15px !important;">
    ...
    <div class="col-md-12 grid-margin">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="dropdown">
            <button onclick="myFunction()" class="dropbtn button">Our Products</button>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12 text-white">
                  <h3 class="dashboard-text" style="font-size: 20px;"> INR <?= $db->get_institute_walletamount($user_id, '8') ?> <a href="page.php?page=ourRechargeHistory" class="btn btn-warning btn1" style="padding: 5px 5px !important;">View History</a> </h3>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12 text-white">
                  ...
                  <a href="page.php?page=ourStudentFeesHistory" class="btn btn-primary btn1" style="padding: 10px 10px !important;">View History</a>
        ...
        <div class="col-md-3 mb-4 mb-lg-0 stretch-card transparent stretch-card1">
          <div class="card card-light-blue" style=" background-image: url('resources/icons/a4.jpg');background-size: 100% 100%;">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12 text-white">
                  <h5 class="dashboard-text">Total Expenses : INR <?= $db->get_totalexpenses($user_id) ?> </h5>
                  <a href="page.php?page=listExpenses" class="btn btn-primary btn1" style="padding: 10px 10px !important;">View History</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="row">
    ...
    <div class="col-md-3 mb-4 stretch-card transparent stretch-card1">
      <div class="card card-light-blue" style=" background-image: url('resources/icons/a5.jpg');background-size: 100% 100%;">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-12 text-white">
              <h5 class="dashboard-text">Approval Pending : <?= $admin->getTotalCertificateRequests('1', " AND INSTITUTE_ID = $user_id ") ?></h5>
              <h5 class="dashboard-text">Certificate Approved :<?= $admin->getTotalCertificateRequests('2', " AND INSTITUTE_ID = $user_id ") ?></h5>

              <h5 class="dashboard-text">Order Pending : <?= $admin->getTotalCertificateRequestsOrder('1', " AND INSTITUTE_ID = $user_id ") ?></h5>
              <h5 class="dashboard-text">Order Certificate Approved : <?= $admin->getTotalCertificateRequestsOrder('2', " AND INSTITUTE_ID = $user_id ") ?></h5>
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-12 text-white">
              ...
              <a href="page.php?page=printFranchiseCertificate&inst=<?php echo $user_id ?>" target="_blank" class="btn btn-primary btn1">Download </a>

              <br /><br />
              <a href="page.php?page=print-performance-certificate-cover&inst[]=<?php echo $user_id ?>" target="_blank" class="btn btn-warning btn1">Performance Certificate </a>
    ...
    <?php
    $res = $institute->list_institute($user_id, '');
    if ($res != '') {
      $srno = 1;
      while ($data = $res->fetch_assoc()) {
        extract($data);
      ...
      <div class="card">
        <div class="card-body">
          ...
          <ul class="icon-data-list">
            ...
            $day     = isset($_REQUEST['day']) ? $_REQUEST['day'] : date('d');
            $cond = '';
            $res = $admin->get_birth_day_report($month, $day, " AND INSTITUTE_ID = $user_id ORDER BY DAY(A.STUDENT_DOB) ASC");
            if ($res != '') {
              $srno = 1;
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between">
            <p class="card-title">Balance Fees Report</p>
          </div>
