...
?>
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Update Offline Paper Result </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="page.php?page=list-offline-exam-papers">Offline Exams</a></li>
        <li class="active">  Update Offline Paper Result</li>
      </ol>
    </section>
		 ...
		 <form role="form" class="form-validate" action="" method="post" enctype="multipart/form-data" onsubmit="pageLoaderOverlay('show');" id="add_student">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update Offline Paper Result</h3>
            </div>
            <div class="box-body">			 
		...
		<input type="hidden" name="student_id" value="<?= $STUDENT_ID ?>" />				
				...
				<div class="form-group <?= (isset($errors['scananswersheet']))?'has-error':'' ?>">
                  ...
                  <div class="col-sm-8">
					...
					{
						$path = '../uploads/exam/offline/'.$STUDENT_ID.'/'.$OFFLINE_ANS_PROOF;
						echo '<a href="'.$path.'" class="btn btn-xs bg-purple" target="_blank">Download</a><br>';
					}
