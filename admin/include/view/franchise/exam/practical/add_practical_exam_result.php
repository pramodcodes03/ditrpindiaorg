							...
							<div class="col-md-12">
									...
									<div class="table-responsive pt-3">
										<table id="order-listing" class="table" style="font-size:12px; ">
											...
											$res1 = $coursemultisub->get_course_subject_added_by_institute($MULTI_SUB_COURSE_ID,$user_id, false);  
											if($res1!='')
											{
												$srno=1;
							...
							<div class="col-md-12">
									...
									<div class="table-responsive pt-3">
										<table id="order-listing" class="table" style="font-size:12px; ">
											...
											$res1 = $coursetyping->get_course_subject_added_by_institute($TYPING_COURSE_ID,$user_id, false);  
											if($res1!='')
											{
												$srno=1;
												while($data1 = $res1->fetch_assoc())
												{
												   // print_r($data1); exit();
													...
													$TYPING_COURSE_SPEED 	= $data1['SPEED_NAME'];
