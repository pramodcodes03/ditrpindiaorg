          ...
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6 form-group">
                ...
                <select class="form-control form-control-sm" id="courseid" id="courseid" name="courseid" onchange="setCourseName(this.value)">
                  <?php
                ...
                <div class="" style="display: flex;">
                  ...
                  <div style="display: flex; margin: auto;">
                    ...
                    ?>
                        ...
                        <input class="form-control" name="exam_mode[]" value="<?= $EXAM_TYPE_ID ?>" <?= (in_array($EXAM_TYPE_ID, $exam_mode)) ? "checked=''" : ''  ?> type="checkbox" style="height: 20px; float: left; text-align: left; width: 45px;">
                        <?= $EXAM_TYPE ?> &nbsp;&nbsp; &nbsp;&nbsp;
