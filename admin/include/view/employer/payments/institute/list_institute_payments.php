 ...
 <div class="content-wrapper">
 	...
 	<section class="content-header">
 		...
 		<h1>
 			...
 			List Institute Payments

 			<small>All Institute Payments</small>
 		...
 		<ol class="breadcrumb">
 			...
 			<li class="active">List Institute Payments</li>
 				...
 				<div class="box box-primary">
 					...
 					<div class="box-body">
 						...
 						<form action="" method="post" onsubmit="pageLoaderOverlay('show')">
 							...
 							<input type="hidden" nue="list-student-payments" />
 							...
 							<div class="form-group col-sm-2">
 								...
 								<?php $institute_id = isset($_REQUEST['institute_id']) ? $_REQUEST['institute_id'] : ''; ?>

 								<select class="form-control select2" name="institute_id" id="institute_id">

 									<?php echo $db->MenuItemsDropdown('certificate_requests', "INSTITUTE_ID", "INSTITUTE_NAME", "DISTINCT INSTITUTE_ID, get_institute_name(INSTITUTE_ID) AS INSTITUTE_NAME", $institute_id, " WHERE DELETE_FLAG=0"); ?>
 						...
 						<table class="table table-bordered table-hover data-tbl">
 							...
 							<tbody>
 								...
 								<?php
									...
									$payments = $admin->list_institute_payments($cert_req_id, $condition);
							...
							";
										  ...
										  <td>$PAYMENT_DATE_ON</td>											 

										  <td>$INSTITUTE_NAME</td>																				  <td>$TOTAL_EXAM_FEES_RECIEVED</td>											  	

										  <td>$TOTAL_EXAM_FEES_BALANCE</td>										  
