...
if($course_multi_sub!=='' && !empty($course_multi_sub)){
	...
	.studname{position:absolute;top:25%;left:32%;width:35%}
	.fathername{position:absolute;top:26.8%;left:32%; width:35%}
	.surname{position:absolute;top:28.4%;left:32%; width:35%}
	.institudename{position:absolute;top:34.2%;left:32%;width:100%;font-size: 10pt;text-transform: uppercase;}
	.dob{position:absolute;top:28.4%;left:70.4%; width:15%}
	
	.courseperiod{position:absolute;top:30%;left:70.4%; width:40%;}
	
	.coursedur{position:absolute;top:25%;left:70.4%; width:15%}
	.coursename{position:absolute;top:31.9%;left:32%; border:1px }
	.mothername{position:absolute;top:30%;left:32%; width:23%}
	.marksheetno{position:absolute;top:26.8%;left:70.4%; width:30%}
	...
	.total_bottom{position:absolute;top:68.2%;left:78%; font-size:16px;height:50px;width:50px; }
    ...
    .period_date{font-weight:normal;font-size: 9pt; }
     ...
     .weblink{position:absolute;top:91%;left:42%; font-size:16px;}
	 .qrheadtext{position:absolute;top:78.5%;left:57%; font-size:10px;font-weight:900; text-align:center; width:170px;}
	 .qrcodeimage{position:absolute;top:79.5%;width:80px; height:80px; text-align:center; float:right; left:46.4%;}
	...
	if($COURSE_ID!='' && !empty($COURSE_ID) && $COURSE_ID!=0){
		...
		$html .="<div class='coursedur'>$cour_dur</div>";
	...
	if($MULTI_SUB_COURSE_ID!='' && !empty($MULTI_SUB_COURSE_ID) && $MULTI_SUB_COURSE_ID!=0){
		...
		$res2 = $exammultisub->list_student_exam_results_multi_sub_list('',$STUDENT_ID,$INSTITUTE_ID,$STUD_COURSE_ID,'');
					...
					while($data2 = $res2->fetch_assoc())
					{
						...
						$marksHtml .="<td width='6%'>$MARKS_OBTAINED1</td>";
						$marksHtml .="<td width='6%'>$PRACTICAL_MARKS1</td>";	
						$marksHtml .="<td width='6%'>$totalmks</td>";	
						$marksHtml .= '</tr>';
