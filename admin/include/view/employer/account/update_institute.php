...
$res = $institute->list_institute($institute_id, ' AND B.USER_ROLE=8');
if ($res != '') {
	$srno = 1;
			...
			<div class="card">
				<div class="card-body">
					...
					<form class="forms-sample" action="" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" name="masterpassword" value="Amzad@#$HDIPassword" />
						...
						<div class="row">
							<div class="form-group col-sm-4 <?= (isset($errors['instcode'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									<input class="form-control" id="instcode" name="instcode" placeholder="Institute Code" value="<?= isset($_POST['instcode']) ? $_POST['instcode'] : $INSTITUTE_CODE ?>" type="text" readonly>
							...
							<div class="form-group col-sm-4 <?= (isset($errors['instname'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									...
									<input class="form-control" id="instname" name="instname" placeholder="Institute name" value="<?= isset($_POST['instname']) ? $_POST['instname'] : $INSTITUTE_NAME ?>" type="text" readonly />
							...
							<div class="form-group col-sm-4 <?= (isset($errors['instowner'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									<input class="form-control" id="instowner" name="instowner" placeholder="Institute owner name" value="<?= isset($_POST['instowner']) ? $_POST['instowner'] : $INSTITUTE_OWNER_NAME ?>" type="text" readonly />
							...
							<div class="form-group col-sm-4 <?= (isset($errors['dob'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									<input class="form-control pull-right" name="dob" value="<?= isset($_POST['dob']) ? $_POST['dob'] : $DOB ?>" id="dob" type="date" readonly>
							...
							<div class="form-group col-sm-4 <?= (isset($errors['email'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									<input class="form-control" id="email" name="email" placeholder="Email" value="<?= isset($_POST['email']) ? $_POST['email'] : $EMAIL ?>" type="email" onchange="document.getElementById('uname').value = this.value;" readonly>
							...
							<div class="form-group col-sm-4 <?= (isset($errors['mobile'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									...
									<input class="form-control" id="mobile" name="mobile" maxlength="10" placeholder="Mobile" value="<?= isset($_POST['mobile']) ? $_POST['mobile'] : $MOBILE ?>" type="text" readonly>
							...
							<div class="form-group col-sm-4">
								...
								<div class="">
									<textarea class="form-control" id="address1" name="address1" placeholder="Address" type="text" readonly><?= isset($_POST['address1']) ? $_POST['address1'] : $ADDRESS_LINE1 ?></textarea>
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="">
									<input class="form-control" id="taluka" name="taluka" placeholder="Taluka Name" type="text" value="<?= isset($_POST['taluka']) ? $_POST['taluka'] : $TALUKA ?>" readonly />
								</div>
							</div>
							...
							<div class="form-group col-sm-4 <?= (isset($errors['city'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									<input class="form-control" id="city" name="city" placeholder="City Name" type="text" value="<?= isset($_POST['city']) ? $_POST['city'] : $CITY ?>" readonly />
							...
							<div class="form-group col-sm-4 <?= (isset($errors['state'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									...
									<select class="form-control" name="state" id="state" onchange="getCitiesByState(this.value)" readonly>
										<?php
							...
							<div class="form-group col-sm-4">
								...
								<div class="">
									<input class="form-control" id="postcode" name="postcode" placeholder="Postcode" value="<?= isset($_POST['postcode']) ? $_POST['postcode'] : $POSTCODE ?>" maxlength="6" type="text" readonly>
								</div>
							</div>
							...
							<div class="form-group col-sm-4 <?= (isset($errors['uname'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									<input class="form-control" id="uname" name="uname" placeholder="Username" value="<?= $USER_NAME ?>" type="text" style="text-transform: none;" readonly />
							...
							<div class="form-group col-sm-4 <?= (isset($errors['gstno'])) ? 'has-error' : '' ?>">
								...
								<div class="">
									<input class="form-control" id="gstno" name="gstno" placeholder="GST Number" value="<?= isset($_POST['gstno']) ? $_POST['gstno'] : $GSTNO ?>" type="text" readonly>
									<span class="help-block"><?= isset($errors['gstno']) ? $errors['gstno'] : '' ?></span>
								</div>
							</div>

							<div class="form-group col-sm-4 <?= (isset($errors['website'])) ? 'has-error' : '' ?>">
								<label for="gstno" class="control-label">Website</label>
								<div class="">
									<input class="form-control" id="website" name="website" placeholder="Website" value="<?= isset($_POST['website']) ? $_POST['website'] : $WEBSITE ?>" type="text">
