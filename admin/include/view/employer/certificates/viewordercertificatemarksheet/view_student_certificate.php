...
if ($checkstud != '' && !empty($checkstud)) {
	...
	.studphoto{position:absolute;top:385px;right:42.9%;width:118px; height:143px;background-image:url("' . $STUD_PHOTO . '"); background-size:118px 143px; background-repeat:no-repeat;}
	</style>';
	$html .= '
