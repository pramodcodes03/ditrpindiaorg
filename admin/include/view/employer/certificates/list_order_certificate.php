											...
											<tbody>
												...
												if ($res != '') {
													...
													while ($data = $res->fetch_assoc()) {
														...
														$checkstud = isset($_POST['checkstud']) ? $_POST['checkstud'] : '';
														$checkbox = "<td>";
														if ($db->permission('list_apply_certificate') && $ORDER_FOR_CERTIFICATE == 0)
							...
							";
												...
												if ($exam_result_info_typing != '') {
													...
													while ($data = $exam_result_info_typing->fetch_assoc()) {
														...
														$checkbox1 = "<td>";
														if ($db->permission('list_apply_certificate') && $ORDER_FOR_CERTIFICATE == 0)
															$checkbox1 .= "<input type='checkbox' name='checkstud_typing[]' id='checkstud_typing$EXAM_RESULT_FINAL_ID' value='$EXAM_RESULT_FINAL_ID' $disableCheck onchange='validateordercount()' />";
														$checkbox1 .= "</td>";
