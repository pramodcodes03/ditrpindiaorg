...
if ($checkstud != '' && !empty($checkstud)) {
	...
	*/
	...
	.marks{	position:absolute;top:715px;left:69%; width:100px;}
	...
	.certicateno{position:absolute;	bottom:75px;left:35%;}
	.date{position:absolute;bottom:55px;left:35%;}
	...
	.studphoto{position:absolute;top:420px;right:42.9%;width:105px; height:125px;background-image:url("' . $STUD_PHOTO . '"); background-size:105px 125px; background-repeat:no-repeat; display:block;}
	.qrheadtext{position:absolute;top:28.7%;left:73%; font-size:12px;font-weight:900; text-align:center; width:150px;}
    .qrcodeimage{position:absolute;top:33.1%;width:85px; height:85px; text-align:center; float:right; left:77%;}
	</style>';
	if ($ISSUE_DATE >= '2023-11-09') {
		$backgroundImage = "resources/dist/img/newCertificate.jpeg";
	} else {
		$backgroundImage = "resources/dist/img/democertificate.jpg";
	}
   ...
   <div class="qrcodeimage"><img src="' . $file . '"></div>';
	...
	<div class="studphoto"></div>
				...
				<h3 class="date"> Date Of Issue :' . $ISSUE_DATE_FORMAT . '</h3>
				 <div class="weblink"> www.ditrpindia.com </div>
