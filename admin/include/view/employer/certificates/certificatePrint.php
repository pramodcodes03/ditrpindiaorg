...
if ($checkstud != '' && !empty($checkstud)) {
	...
	.studname{position:absolute;top:587px;text-align:center;width:100%;}
	.idproof{position:absolute;top:610px;text-align:center;width:100%;font-weight:normal}
	
	.atcname{position:absolute;top:655px;text-align:center;width:100%; font-size:14px; color:#f90404;text-transform:uppercase}
	
	.grade{position:absolute;top:707px;left:56%; width:100px;}
	.marks{	position:absolute;top:707px;left:71.5%; width:100px;}
	...
	.certicateno{position:absolute;	bottom:162px;left:39%; font-size:13px;}
	.date{position:absolute;bottom:142px;left:39%; font-size:13px;}
	
	.courseperiod{position:absolute;top:805px;text-align:center;width:100%; font-size:10px;font-weight:normal;}
	
	.studphoto{position:absolute;top:365px;right:42.9%;width:112px; height:125px;background-image:url("' . $PHOTO . '"); background-size:112px 125px; background-repeat:no-repeat; border:2px solid #000;}

	.studsign{position:absolute;top:500px;left:40.9%;width:135px; height:40px;background-image:url("' . $STUD_SIGN . '"); background-size:135px 40px; background-repeat:no-repeat; border:2px solid #000;}
    ...
    .weblink{position:absolute;bottom:45px;left:56%; font-size:16px;}
...
<div class="qrcodeimage"><img src="' . $file . '"></div> 
	...
	<div class="studsign"></div>
				...
				<h3 class="bottomatcname">' . htmlspecialchars_decode($mainInstituteName) . '</h3>
