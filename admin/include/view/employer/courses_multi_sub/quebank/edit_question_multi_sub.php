...
if ($action != '') {
  ...
  $result = $exammultisub->edit_question_multi_sub($que_id);
  ...
  if ($success == true) {
    ...
    header('location:page.php?page=viewQueBankMultiSub&id=' . $quebank_id);
  }
}
/* get que bank details */

$res = $exammultisub->get_question_detail_multi_sub($que_id, '');
if ($res != '') {
...
<div class="content-wrapper">
  <div class="row">
    <div class="col-8 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Update Question For Courses With Multiple Subjects </h4>
