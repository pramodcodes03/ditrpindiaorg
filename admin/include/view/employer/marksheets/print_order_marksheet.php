...
if($course_multi_sub!=='' && !empty($course_multi_sub)){
	...
	.total_bottom{position:absolute;top:69.7%;left:79%; font-size:16px;height:50px;width:50px; }
