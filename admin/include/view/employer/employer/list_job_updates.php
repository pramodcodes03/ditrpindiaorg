	...
	<div class="row">
        <div class="col-xs-12">
          <div class="box">
			...
			$res = $employer->list_jobs('','',' AND A.ACTIVE=0');
			if($res!='')
			{
				$srno=1;
				...
				{
					extract($data);
					if($db->permission('approve_jobs')){
						if($JOB_STATUS==1)
						$JOB_STATUS = '<a href="javascript:void(0)" style="color:#3c763d" onclick="changeJobPostStatus('.$JOB_POST_ID.',0)"><i class="fa fa-check"></i></a>';
						elseif($JOB_STATUS==0)	
						$JOB_STATUS = '<a href="javascript:void(0)" style="color:#f00" onclick="changeJobPostStatus('.$JOB_POST_ID.',1)"><i class="fa fa-times"></i></a>';	
					}else{
						if($JOB_STATUS==1)
						$JOB_STATUS = '<span style="color:#3c763d"><i class="fa fa-check"></i></span>';
						elseif($JOB_STATUS==0)	
						$JOB_STATUS = '<span style="color:#f00"><i class="fa fa-times"></i></span>';
					}
					/*
