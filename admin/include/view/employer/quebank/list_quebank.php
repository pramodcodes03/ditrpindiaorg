 <div class="content-wrapper">
 	<div class="col-lg-12 stretch-card">
 		<div class="card">
 			<div class="card-body">
 				<h4 class="card-title">List Question Banks
 							...
 							<?php
								...
								if ($res != '') {
									...
									while ($data = $res->fetch_assoc()) {
										...
										$TOTAL_QUE 		= $exam->count_total_question($COURSE_ID);
										...
										$view_quebank = 'page.php?page=viewQueBank&course=' . $COURSE_ID . '&id=' . $QUEBANK_ID;
										...
										if ($db->permission('delete_que_bank'))
											...
											$action .= "<a href='javascript:void(0)' onclick='deleteQueBank($QUEBANK_ID)' class='btn btn-danger table-btn' title='Delete'><i class='mdi mdi-delete'></i></a>";

										if ($db->permission('empty_que_bank'))

											$action .= "<a href='javascript:void(0)' onclick='emptyQueBank($QUEBANK_ID)' class='btn btn-warning btn1' title='Empty'>Empty</a>
