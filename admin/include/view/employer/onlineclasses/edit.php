...
$action = isset($_POST['update_onlineclasses_details']) ? $_POST['update_onlineclasses_details'] : '';
...
if ($action != '') {
  ...
  $result = $tools->update_onlineclasses_details($id);
...
$res = $tools->list_onlineclasses_details($id, '');
if ($res != '') {
  $srno = 1;
...
<div class="content-wrapper">
  <div class="row">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Edit Online Classes</h4>
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
              ...
              <select class="form-control select2" name="course_id" data-placeholder="Select a Course" id="coursename" required>
                ...
                if ($ex && $ex->num_rows > 0) {
                  while ($data = $ex->fetch_assoc()) {
                    ...
                    $selected = '';
                    if ($INSTITUTE_COURSE_ID == $course_id) {
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="expirydate" name="expirydate" placeholder="Expiry Date" value="<?= isset($_POST['expirydate']) ? $_POST['expirydate'] : $expirydate ?>">
            </div>

            <input type="submit" name="update_onlineclasses_details" class="btn btn-primary mr-2" value="Submit">
