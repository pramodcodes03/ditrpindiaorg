                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-3 <?= (isset($errors['batch'])) ? 'has-error' : '' ?>">
                            ...
                            <select class="form-control select2" name="student_id" id="student_id" onchange="getStudentAllCourses(this.value); getStudPaymentInfo(); getBalAmtCourse();">
                                <?php
                                echo $db->MenuItemsDropdown('student_details', "STUDENT_ID", "STUDENT_NAME", "STUDENT_ID, CONCAT(CONCAT(STUDENT_FNAME,' ',STUDENT_MNAME),' ',STUDENT_LNAME) STUDENT_NAME", $student_id, " WHERE DELETE_FLAG=0 AND INSTITUTE_ID = $institute_id");
                                ?>
                            </select>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="row text-white">
                                                    ...
                                                    ?>
                                                            <div class="col-md-3">
                                                                <img class="img-rounded" src="<?= $STUD_PHOTO ?>" alt="<?= $STUDENT_FULLNAME ?>" style="width: 150px !important; border-radius: 10%;    margin-right: 150px;">
                                                            </div>
                                                            <div class="col-md-8">
                                                                <h5 class="dashboard-text">Student Name : <?= $STUDENT_FULLNAME ?></h5>
                                                                <h5 class="dashboard-text">Course Name : <?= $course_name ?></h5>
                                                            </div>
