...
<div class="content-wrapper">
	<div class="col-lg-12 stretch-card">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title">My Wallet Details
				</h4>
											...
											<div class="col-8 text-white">
												<table class="table">
													<tbody>
														...
														$res = $access->get_wallet('', $institute_id, 8);
														if ($res != '') {
															...
															?>
																<tr>
																	<td colspan="4">Your wallet balance is empty!
																		<!-- <a href="page.php?page=rechargeWalletFranchise" class="btn btn-primary btn1">Recharge Now</a> -->
																	</td>
																</tr>
												...
												<?php if ($db->permission('view_recharge_history')) { ?>
													<a href="page.php?page=ourRechargeHistory" class="btn btn-warning btn1">View History</a>
												<?php } ?>
							...
							if ($res != '') {
								...
								while ($data = $res->fetch_assoc()) {
									...
									if ($image != '') {
										...
										$image = 'resources/icons/a2.jpg';
									}

									$todays_date = date("Y-m-d");

									if ($date <= $todays_date && $end_date >= $todays_date) {

							?>

										<div class="col-md-4 mb-4 stretch-card transparent stretch-card1">
											<div class="card card-tale" style=" background-image: url('<?= $image ?>');background-size: 100% 100%;">

												<div class="card-body">
													<p class="card-title text-white"><?= $name ?></p>
													<div class="row">
														<div class="col-12 text-white">
															<p><?= $description ?></p>
															<p>Start Date : <?= date("d-m-Y", strtotime($date)) ?></p>
															<p>End Date : <?= date("d-m-Y", strtotime($end_date)) ?></p>
