<?php
$supporttcat_id = isset($_GET['id']) ? $_GET['id'] : '';
$action = isset($_POST['update_support_category']) ? $_POST['update_support_category'] : '';
include_once('include/classes/helpsupport.class.php');
$helpsupport = new helpsupport();
if ($action != '') {
  $result = $helpsupport->update_support_cat($supporttcat_id);
...
/* get course details */
$res = $helpsupport->list_support_cat($supporttcat_id, '');
if ($res != '') {
  $srno = 1;
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="page.php?page=list-support-type">Help Support</a></li>
      <li class="active">Update Support Category </li>
    </ol>
  </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <input type="hidden" name="supporttcat_id" value="<?= isset($SUPPORT_CAT_ID) ? $SUPPORT_CAT_ID : '' ?>" />
              ...
              <div class="form-group col-sm-12 <?= (isset($errors['supporttype'])) ? 'has-error' : '' ?>">
                ...
                <div class="col-sm-4">
                  <select class="form-control" id="supporttype" name="supporttype">
                    <?php
                    $support_type = isset($_POST['supporttype']) ? $_POST['supporttype'] : $SUPPORT_TYPE_ID;
              ...
              <div class="form-group col-sm-12 <?= (isset($errors['supportcat'])) ? 'has-error' : '' ?>">
                ...
                <div class="col-sm-4">
                  <input class="form-control" id="supportcat" name="supportcat" placeholder="Support Category Name" value="<?= isset($_POST['supportcat']) ? $_POST['supportcat'] : $CATEGORY_NAME ?>" type="text">
            ...
            <div class="box-footer text-center">
              ...
              <input type="submit" name="update_support_category" class="btn btn-info" value="Update Support Category" />
            </div>
          </div>
        </div>
      </div>
