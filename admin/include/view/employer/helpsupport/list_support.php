        ...
        <div class="table-responsive pt-3">
          <table id="order-listing" class="table">
            ...
            <tbody>
              ...
              $res = $helpsupport->list_support('', " AND INSTITUTE_ID = $user_id AND STUDENT_ID != '' ");
              if ($res != '') {
                $srno = 1;
                while ($data = $res->fetch_assoc()) {
                  ...
                  $action = "<a href='replySupport&id=$TICKET_ID' class='btn btn-primary btn1' title='View Help Support'><i class='fa fa-envelope'> View</i></a>";
