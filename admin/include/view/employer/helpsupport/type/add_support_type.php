<?php
$action = isset($_POST['add_support_type']) ? $_POST['add_support_type'] : '';
include_once('include/classes/helpsupport.class.php');
$helpsupport = new helpsupport();
if ($action != '') {
  $result = $helpsupport->add_support_type();
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Add Support Type </li>
    </ol>
  </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Support Type</h3>
            </div>
            <div class="box-body">
              ...
              <div class="form-group col-sm-6 <?= (isset($errors['supporttype'])) ? 'has-error' : '' ?>">
                ...
                <div class="col-sm-8">
                  <input class="form-control" id="supporttype" name="supporttype" placeholder="Support Type" value="<?= isset($_POST['supporttype']) ? $_POST['supporttype'] : '' ?>" type="text">
            ...
            <div class="box-footer text-center">
              ...
              <input type="submit" name="add_support_type" class="btn btn-info" value="Add Support Type" />
            </div>
          </div>
        </div>
      </div>
