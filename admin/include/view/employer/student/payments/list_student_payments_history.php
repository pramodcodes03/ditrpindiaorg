...
<div class="content-wrapper">
	<div class="col-lg-12 stretch-card">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title">List Students Payments History </h4>
				<div class="row">
					<div class="col-12">
						<?php
				...
				<form action="export.php" method="post" class="">
					<input type="hidden" value="studentfeesHistory_export" name="action" />
				...
				<div class="table-responsive pt-3" style="position: relative; top: -85px;">
					<table id="order-listing" class="table">
						...
						<tbody>
							...
							$payments = $institute->list_student_payments_upd_history('', '', $institute_id, '', $cond);
							if ($payments != '') {
								$courseSrNo = 1;
