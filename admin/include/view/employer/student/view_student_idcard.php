...
<style>
	...
	.rollnumber{position:absolute;top:293px;text-align:left;width:100%; font-size:10px; left:1.8%;}
    ...
    .qrcodeimage{position:absolute;top:27.1%;width:40px; height:40px; text-align:center; float:right; left:22%;}
