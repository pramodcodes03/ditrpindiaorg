...
$res = $student->list_student_direct_admission('', $institute_id, '', '');
						...
						<tbody>
							...
							if ($res != '') {
								...
								while ($data = $res->fetch_assoc()) {
									...
									$birthDayColor = "";
									if ($STUDENT_DOB == $todaysDate) {
										$birthDayColor = " style='background-color:#e6fc40'";
									}
									...
									$editLink .= "<br/> <a href='page.php?page=viewResume&id=$STUDENT_ID' target='_blank' style='padding: 10px !important;' class='btn btn-success btn1' title='Resume'> Resume </a>";
							...
							*/
									...
									$editLink .= "  <a href='page.php?page=viewBirthdayCard&id=$STUDENT_ID' target='_blank' class='btn btn-danger table-btn' title='Birthday Card'> <i class='mdi mdi-wallet-giftcard'></i> </a>";


									$params = "'$USER_NAME','" . $PASS_WORD . "'";
									$loginBtn = "<a href='javascript:void(0)' class='btn btn-primary btn1' title='LOGIN' onclick=\"loginToInst($params)\" style='padding: 10px !important;'><i class=' fa fa-sign-in'></i>Login</a>";

									echo " <tr id='id$STUDENT_ID' $birthDayColor>
									<td>$srno</td>	
									<td>$editLink $loginBtn </td>	
							  ...
							  <div class="modal-dialog" role="document">
								<div class="modal-content">
								  ...
								  <div class="modal-body" id="p1">								 
										...
										<p> Mobile App Link :  https://play.google.com/store/apps/details?id=com.app.ditrpindia&pcampaignid=web_share </p>
								  </div>     
								</div>
							  </div>
							</div>
