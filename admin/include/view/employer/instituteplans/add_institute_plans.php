...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Add New Institute Plan

    </h1>
    <ol class="breadcrumb">
      <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Institute Plan</li>
    </ol>
  </section>
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Institute Plan</h3>
            </div>
            <div class="box-body">
            ...
            <div class="box-footer text-center">
              ...
              <input type="submit" name="add_plan" class="btn btn-info" value="Add Institute Plan" />
            </div>
          </div>
        </div>
      </div>
