...
$res = $exam->filter_aicpe_exams('',$institute_id, '','', '');
...

				{
...

					{
						...
						*/
						...
						if($exam_result_info=='' && $exam_result_info_multi_sub=='' && $exam_result_info_typing=='' && $db->permission('list_offline_marks_update'))

						$action = '<a href="page.php?page=addPracticalExamResult&id='.$STUD_COURSE_DETAIL_ID.'" class="btn   btn-primary btn1">Add Result</a>';					

						elseif($db->permission('list_offline_marks_update')){
