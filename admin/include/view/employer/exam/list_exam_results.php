    ...
    <div class="col-lg-12 stretch-card">
		...
		<div class="card-body">
			...
			<table id="order-listing" class="table">
				<thead>
				<tr>				
					<?php  if($db->permission('list_apply_certificate')){ ?>	<th><input type="checkbox" name="selectall" id="selectall" /></th><?php  } ?>
					<th>#</th>
					<th>Photo</th>
					<th>Student</th>
					<th>Course</th>				
				...
				<?php		
					if($res!='')
					{
						...
						//	print_r($data); exit();
							...
							$checkstud = isset($_POST['checkstud'])?$_POST['checkstud']:'';
							$checkbox="<td>";
							if($db->permission('list_apply_certificate') && $APPLY_FOR_CERTIFICATE==0)
