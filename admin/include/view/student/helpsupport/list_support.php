...
<div class="content-wrapper">
  <div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">List Support
          <a href="page.php?page=addSupport" class="btn btn-primary" style="float: right">Add Help Support</a>
        </h4>
        <?php
        ...
        <div class="table-responsive pt-3">
          <table id="order-listing" class="table">
            ...
            <tbody>
              ...
              $res = $helpsupport->list_support('', " AND STUDENT_ID='$user_id' AND INSTITUTE_ID = $inst_id ");
              if ($res != '') {
                $srno = 1;
