...
$action = isset($_POST['add_rechargeoffers']) ? $_POST['add_rechargeoffers'] : '';

if ($action != '') {
	include_once('include/classes/websiteManage.class.php');
	$websiteManage = new websiteManage();

	$result	= $websiteManage->add_rechargeoffers();
...
<div class="content-wrapper">
	<div class="row">
		<div class="col-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Add Recharge Offers </h4>
									...
									<div class="box-body row">
										<form role="form" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
											...
											<div class="form-group col-sm-6 <?= (isset($errors['date'])) ? 'has-error' : '' ?>">
												...
												<div class="col-xs-6">
													<input type="date" name="date" class="form-control" id="date" placeholder="date" value="<?= isset($_POST['date']) ? $_POST['date'] : '' ?>" />
											...
											<div class="form-group col-sm-6 <?= (isset($errors['end_date'])) ? 'has-error' : '' ?>">
												...
												<div class="col-xs-6">
													<input type="date" name="end_date" class="form-control" id="end_date" placeholder="end_date" value="<?= isset($_POST['end_date']) ? $_POST['end_date'] : '' ?>" />
											...
											<div class="form-group col-sm-6 <?= (isset($errors['time'])) ? 'has-error' : '' ?>">
												...
												<div class="col-xs-6">
													<input type="text" name="time" class="form-control" id="time" placeholder="time" value="<?= isset($_POST['time']) ? $_POST['time'] : '' ?>" />
											...
											<div class="box-footer text-center">
												<input type="submit" class="btn btn-primary" name="add_rechargeoffers" value="Add" /> &nbsp;&nbsp;&nbsp;
