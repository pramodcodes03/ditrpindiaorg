...
if ($action != '') {
	...
	if ($success == true) {
		...
		header('location:page.php?page=listStudentFees');
	}
}
					...
					<form class="forms-sample" action="" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="form-group col-sm-6 <?= (isset($errors['fees_date'])) ? 'has-error' : '' ?>">
								<label> Date </label>
								<input class="form-control pull-right" name="fees_date" value="<?= isset($_POST['fees_date']) ? $_POST['fees_date'] : '' ?>" id="fees_date" type="date" max="2999-12-31">
