...
if($user_id!='' && !empty($user_id))
{
    ...
    .name{position:absolute;top:9%;left:45%;width:35%; font-size:22pt;}
	.studname{position:absolute;top:18.5%;left:43%;width:35%; font-size: 9pt;}
    ...
    .studphoto{position:absolute;top:77px;left:9.1%;width:200px; height:200px;background-image:url("'.$STUD_PHOTO.'"); background-size:200px 200px; background-repeat:no-repeat; border-radius:100%;}
     .bottom_name{position:absolute;bottom:13%;width:40%; font-size:16px; float:right; margin-right:0px;}
	</style>';
  $html .= '
