...
<style>
	...
	.rollnumber{position:absolute;top:298px;text-align:left;width:100%; font-size:12px; left:1.8%;}
    ...
    .qrcodeimage{position:absolute;top:30%;width:40px; height:40px; text-align:center; float:right; left:20%;}
