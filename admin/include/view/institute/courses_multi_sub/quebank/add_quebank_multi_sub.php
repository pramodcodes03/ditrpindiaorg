			...
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Add Question Bank For Courses With Multiple Subjects
						<a href="<?= QUEBANK_PATH ?>/sample.zip" target="_blank" class="btn btn-primary" style="float: right">Download Sample CSV</a>
					</h4>
					<form class="forms-sample" action="" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								...
								<select class="form-control select2" id="exampleFormControlSelect3" id="courseid" name="courseid" onchange="getSubjectId(this.value)">
									<?php
	            ...
	            <ul>
					...
					<li>For example: <a href="<?= QUEBANK_PATH ?>/images.zip">Download Zip</a></li>
						...
						<a href="listQueBankMultiSub" class="btn btn-danger mr-2" title="Cancel">Cancel</a>
					</form>
				</div>
			</div>
		</div>
