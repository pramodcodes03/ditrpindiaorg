 									...
 									<?php
										...
										if ($res != '') {
											...
											while ($data = $res->fetch_assoc()) {
												...
												// $action = '<a <a href="#"  onclick="getpopup('.$CERTIFICATE_REQUEST_ID.')" value="'.$CERTIFICATE_REQUEST_ID.'"><i class="fa fa-plus" aria-hidden="true"></i>Add</a>';
												...
												//$action .= '<a <a href="#" data-target="#myModalupdate" class="edit" data-toggle="modal">edit</a>';
