 <?php
	...
	if ($action == 'Apply marksheet') {
		...
		if ($success == true) {
			...
			header('location:page.php?page=list-marksheet');
		}
	}
	...
	$cond .= " AND A.MARKSHEET_REQUEST_STATUS IN(0,1)";
 									...
 									<?php
										...
										if ($res != '') {
											...
											while ($data = $res->fetch_assoc()) {
												...
												$action = '<a <a href="#"  onclick="getpopup(' . $CERTIFICATE_REQUEST_ID . ',' . $STUDENT_ID . ',' . $institute_id . ')" value="' . $CERTIFICATE_REQUEST_ID . '"><i class="fa fa-plus" aria-hidden="true"></i>Add</a>';
