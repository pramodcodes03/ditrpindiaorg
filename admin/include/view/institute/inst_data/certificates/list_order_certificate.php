 ...
 <div class="content-wrapper">
 	...
 	<section class="content-header">
 		...
 		<ol class="breadcrumb">
 			...
 			<li><a <a href="#"> Certificate</a></li>
 			<li class="active"> All Order Certificate</li>
 		</ol>
 	</section>
 	...
 	<section style="background-color: #ffff00; padding: 5px;">
 		...
 		<h5 style="color: #f00;"><b>IMPORTANT NOTE:</b> From 1st January 2022 postal charges have been changed (Due to increase of petrol, diesel price hike, postal charges has been increased.) including packing material & labour charges</h5>
 		<h5 style="color: #f00;"><b>&nbsp;&nbsp; POSTAL CHARGES 2022:</b><br>
 			&nbsp;&nbsp;&emsp;1 to 10 certificates order charges 120/- <br>
 			&nbsp;&nbsp;&emsp;11 to 15 certificates order charges 160/- <br>
 			&nbsp;&nbsp;&emsp;16 to 20 certificates order charges 200/- <br>
 			&nbsp;&nbsp;&emsp;21 to 25 certificates order charges 250/- <br>
 			&nbsp;&nbsp;&emsp;26 to 30 certificates order charges 300/- <br>
 			&nbsp;&nbsp;&emsp;31 and above certificates order charges as per weight <br><br><br>

 			&nbsp;&nbsp;&emsp;A) ₹ 100/- will be deducted instantly & remaining amount (if applicable) will be deducted within 24 hours of ordering.<br>
 			&nbsp;&nbsp;&emsp;B) Reprint charges : 100/- per certificate and mark sheet<br>
 			&nbsp;&nbsp;&emsp;C) If certificates are missing in parcel you have to contact in DITRP with two days<br>
 			&nbsp;&nbsp;&emsp;D) After two day if you call us then you have to pay reprint as well as courier charges<br>
 		</h5>
 	...
 	<section class="content">
 		...
 		<div class="row">
 			<form action="" method="post" class="form-inline" onsubmit="return confirm('Confirm! Order for certificates certificate?'); pageLoaderOverlay('show')">
 				<div class="col-xs-12">
 					<div class="box box-warning">
 						<div class="box-header">

 							<?php if ($db->permission('apply_certificate')) {	?>
 								<input type="submit" class="btn btn-primary" name="submit" value="Order For Certificate" />
 							<?php } ?>
											...
											if ($res != '') {
												...
												while ($data = $res->fetch_assoc()) {
													...
													if ($db->permission('apply_certificate') && $ORDER_FOR_CERTIFICATE == 0)
														$checkbox .= "<input type='checkbox' name='checkstud[]' id='checkstud$EXAM_RESULT_ID' value='$EXAM_RESULT_ID' $disableCheck />";
													$checkbox .= "</td>";
