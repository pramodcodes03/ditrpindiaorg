									...
									<tbody>
										...
										if ($res != '') {
											...
											while ($data = $res->fetch_assoc()) {
												...
												$action = "<a href='page.php?page=view-student-certificate&checkstud=$STUDENT_ID&certreq=$CERTIFICATE_REQUEST_ID&course=$AICPE_COURSE_ID' target='_blank' class='btn' title='View Certificate'><i class='fa fa-eye'></i></a>";
												$action .= "<a href='page.php?page=print-requested-marksheet&checkstud=$STUDENT_ID&certreq=$CERTIFICATE_REQUEST_ID&course=$AICPE_COURSE_ID&course_multi_sub=$MULTI_SUB_COURSE_ID' target='_blank' class='btn' title='View Marksheet'><i class='fa fa-file-text-o'></i></a>";
