...
if($course_multi_sub!=='' && !empty($course_multi_sub)){
	...
	.dob{position:absolute;top:28.9%;left:72.4%; width:15%}
	
	.courseperiod{position:absolute;top:30.2%;left:72.4%; width:40%; font-size:12px; font-weight:normal;}
	
	.coursedur{position:absolute;top:25.5%;left:72.4%; width:15%}
	.coursename{position:absolute;top:32%;left:34%; border:1px }
	.mothername{position:absolute;top:30.2%;left:34%; width:23%}
	.marksheetno{position:absolute;top:27%;left:72.4%; width:30%}
	...
	$html2 .="<div class='weblink'> <b> www.ditrppro.com </b> </div>";
