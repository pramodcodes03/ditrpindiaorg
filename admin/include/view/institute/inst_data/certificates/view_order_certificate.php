 										...
 										<?php
											...
											if ($res != '') {
												...
												while ($data = $res->fetch_assoc()) {
													...
													$action = "<a href='page.php?page=view-order-student-certificate&checkstud=$STUDENT_ID&certreq=$CERTIFICATE_REQUEST_ID&course=$AICPE_COURSE_ID' target='_blank' class='btn' title='View Certificate'><i class='fa fa-eye'></i></a>";
