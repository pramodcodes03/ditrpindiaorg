<?php
$action = isset($_POST['add_festival']) ? $_POST['add_festival'] : '';
include_once('include/classes/festival.class.php');
$festival = new festival();
if ($action != '') {
  $result = $festival->add_festival();
...
<div class="content-wrapper">
  <div class="row">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Add New Festival</h4>
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group col-sm-6 <?= (isset($errors['name'])) ? 'has-error' : '' ?>">
                ...
                <div class="col-sm-8">
                  <input class="form-control" id="name" name="name" placeholder="Festival Name" value="<?= isset($_POST['name']) ? $_POST['name'] : '' ?>" type="text">
              ...
              <div class="form-group col-sm-6 <?= (isset($errors['date'])) ? 'has-error' : '' ?>">
                ...
                <div class="col-sm-8">
                  <input class="form-control" id="date" name="date" placeholder="Date" value="<?= isset($_POST['date']) ? $_POST['date'] : '' ?>" type="date">
              ...
              <input type="submit" name="add_festival" class="btn btn-primary mr-2" value="Add Festival">
