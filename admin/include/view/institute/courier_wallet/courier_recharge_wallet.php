...
if ($action != '') {
	...
	$result	= $access->recharge_courier_wallet_offline();
	...
	if ($success == true) {
		...
		header('location:page.php?page=courierWallet');
	}
}
...
<div class="content-wrapper">
	<div class="row">
		<div class="col-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Courier Wallet Recharge</h4>
					<form class="forms-sample" action="" method="post" enctype="multipart/form-data">
						...
						<div class="box-footer text-center">
							<a href="page.php?page=courierWallet" class="btn btn-warning">Cancel</a>
