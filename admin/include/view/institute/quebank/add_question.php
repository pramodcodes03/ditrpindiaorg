...
if ($action != '') {
  ...
  $result = $exam->add_question($quebank_id);
  ...
  if ($success == true) {
    ...
    header('location:page.php?page=viewQueBank&course=' . $course_id . '&id=' . $quebank_id);
  }
}
        ...
        <div class="card-body">
          ...
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select class="form-control form-control-sm" id="exampleFormControlSelect3" id="courseid" name="courseid" onchange="setCourseName(this.value)">
                <?php
            ...
            <div class="form-group">
              <?php $lang = isset($_POST['lang']) ? $_POST['lang'] : '';  ?>
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control form-control-sm" id="exampleFormControlSelect3" id="course_id" name="course_id" readonly="">
              ...
              echo $db->MenuItemsDropdown("courses", "COURSE_ID", "COURSE_CODE", "DISTINCT COURSE_ID,get_course_title_modify(COURSE_ID) AS COURSE_CODE", $COURSE_ID, " WHERE ACTIVE=1 AND DELETE_FLAG=0 ");
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputName1" name="examname" placeholder="examname" value="<?= isset($_POST['examname']) ? $_POST['examname'] : $EXAM_NAME  ?>" readonly="" disabled="">
          </div>
          </form>
        </div>
      </div>
