						...
						<div class="form-group <?= (isset($errors['democount'])) ? 'has-error' : '' ?>">
							  ...
							  <div class="col-sm-8">
								...
								<span class="help-block"><?= (isset($errors['democount'])) ? $errors['democount'] : '' ?></span>
											...
											<div class="form-group  col-sm-3 <?= (isset($errors['expirationdate'])) ? 'has-error' : '' ?>">
											...
											<div class="form-group col-sm-2">
												<?php
												$prime_member = isset($_POST['prime_member']) ? $_POST['prime_member'] : 0;
												?>
												<label>Prime Member</label>
												<div class="radio">
													<label>
											...
											<div class="form-group col-sm-2">
												...
												<input class="form-control pull-right" value="<?= isset($_POST['prime_memberdate']) ? $_POST['prime_memberdate'] : ''; ?>" id="prime_memberdate" type="date" name="prime_memberdate" max="2999-12-31">
												<span class="help-block"><?= (isset($errors['prime_memberdate'])) ? $errors['prime_memberdate'] : '' ?></span>
											</div>

											<div class="form-group col-sm-2">
												<label>Admissions Count</label>
												<input type="text" class=" form-control" name="prime_admission" value="<?= isset($_POST['prime_admission']) ? $_POST['prime_admission'] : '' ?>" />
											</div>
