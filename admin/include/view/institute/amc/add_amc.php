				...
				<div class="col-sm-12">
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">Add AMC Details</h3>
						</div>
						<div class="box-body">
							...
							<div class="text-center">
								<input type="submit" name="add_amc" class="btn btn-primary" value="ADD" />
								<a <a href="#" class="btn btn-primary">Cancel</a>
							</div>
						</div>
					</div>
				</div>
