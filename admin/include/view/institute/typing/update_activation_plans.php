...
if ($action != '') {
  ...
  $result = $typing->update_typing_activation($plan_id);
  ...
  if ($success == true) {
    ...
    header('location:page.php?page=typing-activation-plans');
  }
}
/* get institute details */
$res = $typing->list_typing_activation_plan($plan_id, '');
if ($res != '') {
  $srno = 1;
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Update Activation Plan</li>
    </ol>
  </section>
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update Activation Plan</h3>
            </div>
            <div class="box-body">
              ...
              <div class="form-group <?= (isset($errors['planvalidity'])) ? 'has-error' : '' ?>">
                <label for="planvalidity" class="col-sm-3 control-label">Plan Validity</label>
                <div class="col-sm-9">
                  <input class="form-control" id="planvalidity" name="planvalidity" placeholder="Plan Validity" value="<?= isset($_POST['planvalidity']) ? $_POST['planvalidity'] : $VALIDITY ?>" type="number">
                  <span class="help-block"><?= (isset($errors['planvalidity'])) ? $errors['planvalidity'] : '' ?></span>
                </div>
              </div>
              ...
              <div class="form-group  <?= (isset($errors['amount'])) ? 'has-error' : '' ?>"">
                ...
                <div class="col-sm-9">
                  <input class="form-control" id="amount" name="amount" maxlength="6" placeholder="Amount" value="<?= isset($_POST['amount']) ? $_POST['amount'] : $AMOUNT ?>" type="number">
            ...
            <div class="box-footer text-center">
              <a href="page.php?page=typing-activation-plans" class="btn btn-default">Cancel</a>
              <input type="submit" name="update_plan" class="btn btn-info" value="Update Plan" />
            </div>
          </div>
        </div>
      </div>
