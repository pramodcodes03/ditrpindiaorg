			  ...
			  <tbody>
						...
						if($res!='')
						{
							...
							while($data=$res->fetch_assoc())
							{
								...
								$action .= '<a <a href="#"  onclick="getpopup('.$EXAM_RESULT_ID.','.$INSTITUTE_COURSE_ID.')" value="'.$EXAM_RESULT_ID.'" class="btn btn-xs btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>Marksheet</a>';
