...
$user_role = isset($_SESSION['user_role'])?$_SESSION['user_role']:'';
 ...
 $res 			= $exam->filter_aicpe_exams($studid,$user_id, $courseid,$examtype, $examstatus);
	   ...
	   <?php } ?>
		 ...
		 if($res!='')
		 {
			 $courseSrNo = 1;
				 ...
				 $reset = "&nbsp;&nbsp;&nbsp;<a href='javascript:void(0)' class='resetexam btn btn-primary' title='Reset' id='rest$STUD_COURSE_DETAIL_ID'><i class='mdi mdi-refresh'></i> Reset</a>";
