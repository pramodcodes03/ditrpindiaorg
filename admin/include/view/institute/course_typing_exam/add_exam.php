...
if ($action != '') {
  ...
  $result = $coursetypingexam->add_exam();
...
<div class="content-wrapper">
  <div class="row">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Add Exam Typing Course</h4>
          <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6 form-group">
                ...
                <select class="form-control form-control-sm select2" id="courseid" name="courseid" onchange="getSubjectIdTyping(this.value)">
                  <?php
              ...
              <div class="col-md-6 form-group">
                ...
                <input type="number" class="form-control" id="totalmarks" name="totalmarks" placeholder="totalmarks" value="<?= isset($_POST['totalmarks']) ? $_POST['totalmarks'] : '' ?>">
              </div>

              <div class="col-md-6 form-group">
                <label>Minimum Marks</label>
                <input type="number" class="form-control" id="minimum_marks" name="minimum_marks" placeholder="minimum_marks" value="<?= isset($_POST['minimum_marks']) ? $_POST['minimum_marks'] : '' ?>">
              </div>
              ...
              <div class="col-md-6 form-group">
                ...
                <div style="display: flex; margin: auto;">
                  ...
                  ?>
                      ...
                      <input class="form-control" name="exam_mode[]" value="<?= $EXAM_TYPE_ID ?>" <?= (in_array($EXAM_TYPE_ID, $exam_mode)) ? "checked=''" : ''  ?> type="checkbox" style="height: 20px; float: left; text-align: left; width: 45px;" <?php if ($EXAM_TYPE == "OFFLINE") {
                                                                                                                                                                                                                                                    echo "checked";
                                                                                                                                                                                                                                                  } ?>>
                      <?= $EXAM_TYPE ?> &nbsp;&nbsp; &nbsp;&nbsp;
