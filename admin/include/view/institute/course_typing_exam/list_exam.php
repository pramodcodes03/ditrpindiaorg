 <div class="content-wrapper">
 	<div class="col-lg-12 stretch-card">
 		<div class="card">
 			<div class="card-body">
 				<h4 class="card-title">List Exams Typing Course
 					<a href="page.php?page=addExamTypingCourses" class="btn btn-primary" style="float: right">Add Exam</a>
 					...
 					<table id="order-listing" class="table">
 						...
 						<tbody>
 							<?php
								...
								$res = $coursetypingexam->list_exams('', '');
								if ($res != '') {
									$srno = 1;
									while ($data = $res->fetch_assoc()) {
										...
										if ($db->permission('update_exam'))
											$action .= "<a href='page.php?page=updateExamTypingCourses&id=$EXAM_ID' class='btn btn-primary table-btn ' title='Edit'><i class='mdi mdi-grease-pencil'></i></a>";
										if ($db->permission('delete_exam'))
											//$action .= "<a href='javascript:void(0)' onclick='deletecoursetypingexam($EXAM_ID)' class='btn btn-danger table-btn ' title='Delete'><i class='mdi mdi-delete'></i></a>
											//";
