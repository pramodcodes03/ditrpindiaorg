...
if ($inst != '' && !empty($inst)) {
	...
	foreach ($inst as $id) {
		...
		//==============================================================
		$sql = "UPDATE institute_details SET CERTIFICATE_FILE='$certificatefile', CERTIFICATE_DATE='$certificate_date' WHERE INSTITUTE_ID='$INSTITUTE_ID'";
...
<style>
	body {padding:0;font-family: sans-serif; font-size: 10pt;position:absolute;z-index:0;top:0px;border:1px solid #f00;}
	.instname{position:absolute;top:480px;text-align:center;width:100%; font-size: 16px;}
	.instaddress1{position:absolute;top:510px;text-align:center;width:100%; font-size:10px; }
	.instaddress2{position:absolute;top:525px;text-align:center;width:100%; font-size:10px; }
	.applicant{position:absolute;top:545px;text-align:center;width:100%;}
	...
	$_SESSION['msg'] = "Success! Certificate has been generated for institute <strong>$INSTITUTE_NAME</strong>.";
