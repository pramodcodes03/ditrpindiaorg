					...
					<form class="forms-sample" action="" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="form-group col-md-4 <?= (isset($errors['stud_sign'])) ? 'has-error' : '' ?>">
								...
								<span class="help-block"><?= isset($errors['stud_sign']) ? $errors['stud_sign'] : '' ?></span>
								<img src="<?= $SIGN ?>" class="img img-responsive" id="img_preview" style="height:100px;" />
							</div>
							...
							<div class="form-group col-md-4  <?= (isset($errors['certicatedate'])) ? 'has-error' : '' ?>">
								...
								<input class="form-control" id="certicatedate" name="certicatedate" placeholder="Certificate Date" value="<?= isset($_POST['certicatedate']) ? $_POST['certicatedate'] : $ISSUE_DATE_FORMAT ?>" type="date" />
