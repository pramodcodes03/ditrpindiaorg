...
if ($checkstud != '' && !empty($checkstud)) {
	...
	*/
	...
	//$STUD_PHOTO = SHOW_IMG_AWS.'/default_user.png';					
	/*
	if($STUD_PHOTO!='')
		$STUD_PHOTO = SHOW_IMG_AWS.STUDENT_DOCUMENTS_PATH.$STUDENT_ID.'/'.$STUD_PHOTO;*/
	...
	.studname{position:absolute;top:600px;text-align:center;width:100%;}
	.idproof{position:absolute;top:620px;text-align:center;width:100%;font-weight:normal}
	
	.atcname{position:absolute;top:675px;text-align:center;width:100%; font-size:12px; color:#f90404;}
	
	.grade{position:absolute;top:722px;left:54%; width:100px;}
	.marks{	position:absolute;top:722px;left:72%; width:100px;}
	.coursename{position:absolute;top:787px;text-align:center;width:100%; font-size:16px;}
		.courseduration{position:absolute;top:810px;text-align:center;width:100%; font-size:10px;font-weight:normal;}
	.certicateno{position:absolute;	bottom:59px;left:35%; font-size:13px;}
	.date{position:absolute;bottom:39px;left:35%; font-size:13px;}
	
	.courseperiod{position:absolute;top:825px;text-align:center;width:100%; font-size:10px;font-weight:normal;}
	
	.studphoto{position:absolute;top:375px;right:42.9%;width:118px; height:143px;background-image:url("' . $PHOTO . '"); background-size:118px 143px; background-repeat:no-repeat; border:2px solid #000;}
