                    							...
                    							if($STUDENT_PHOTO!='')
                    								$PHOTO = STUDENT_DOCUMENTS_PATH.'/'.$STUDENT_ID.'/'.$STUDENT_PHOTO;*/
																...
																if ($check_print != '') {
																	...
																	//$action .= "<a href='page.php?page=print-order-modify-certificate&cert_detail_id=$CERTIFICATE_DETAILS_ID' target='_blank' class='btn btn-primary table-btn' title='Update Certificate'><i class='mdi mdi-grease-pencil'></i></a>";
