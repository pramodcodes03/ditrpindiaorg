...
$action = isset($_POST['update_rechargerequest_admin']) ? $_POST['update_rechargerequest_admin'] : '';

include_once('include/classes/websiteManage.class.php');
$websiteManage = new websiteManage();

if ($action != '') {
	$result	= $websiteManage->update_rechargerequest_admin();
									...
									<div class="box-body row">
										<form role="form" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
											...
											<div class="form-group col-sm-6 ">
												<label for="inputEmail" class="control-label col-xs-3">Payment Status</label>
												<?php $status1 =  isset($_POST['status1']) ? $_POST['status1'] : $status; ?>
												<div>
													<label class="radio-inline">
														<input type="radio" name="status1" id="status4" value="1" <?= ($status1 == 1) ? 'checked="checked"' : '' ?> />Done
													</label>
													<label class="radio-inline">
														<input type="radio" name="status1" id="status5" value="0" <?= ($status1 == 0) ? 'checked="checked"' : '' ?> />Pending
													</label>
												</div>
											</div>
											...
											<div class="form-group col-sm-6 <?= (isset($errors['remark'])) ? 'has-error' : '' ?>">
												...
												<div class="col-xs-6">
													<input type="text" name="remark" class="form-control" id="remark" placeholder="Remark" value="<?= isset($_POST['remark']) ? $_POST['remark'] : $remark ?>" />
											...
											<div class="box-footer text-center">
												<input type="submit" class="btn btn-primary" name="update_rechargerequest_admin" value="Update Recharge Request" /> &nbsp;&nbsp;&nbsp;
