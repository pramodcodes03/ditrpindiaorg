							...
							<div class="row">
								<div class="form-group col-sm-6">
									...
									<select class="form-control" name="expensetype" id="expensetype">
										...
										echo $db->MenuItemsDropdown('expense_category', 'CATEGORY_ID', 'CATEGORY', 'CATEGORY_ID,CATEGORY', $expensetype, " WHERE ACTIVE=1 AND DELETE_FLAG=0 AND INSTITUTE_ID = $user_id");
										?>
									</select>
								</div>
								<div class="form-group col-sm-6">
