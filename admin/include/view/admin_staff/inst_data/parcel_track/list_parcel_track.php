 				...
 				<div class="col-xs-12">
 					<div class="box box-warning">
 						<div class="box-header">
 							...
 							<a href="https://www.indiapost.gov.in/_layouts/15/dop.portal.tracking/trackconsignment.aspx" class="btn btn-primary" target="blank">View Parcel Status</a>
 						...
 						<div class="box-body">
							...
							';
									while ($data = $res1->fetch_assoc()) {
										...
										if ($TOTAL_REQ > 0) {
											$addpayment  = '<a href="add-examfees-payment&reqid=' . $CERTIFICATE_REQUEST_MASTER_ID . '">Add Payment</a>';
