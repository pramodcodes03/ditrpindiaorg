				...
				<div class="row">
					<div class="col-sm-6">
						...
						<?php if ($db->permission('add_wallet_recharge')) { ?>
							...
							<a href="page.php?page=pay-online" class="btn bg-maroon btn-flat margin">Recharge Now</a>
						...
						<?php } ?>
						<!--<p style="font-size:14px; color:red"> Online payment option is under maintainance, please visit after some time.</p>-->
