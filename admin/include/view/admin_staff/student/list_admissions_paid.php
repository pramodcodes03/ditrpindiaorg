										...
										?>
 											<tr id="row-<?= $STUD_COURSE_DETAIL_ID ?>">
 												...
 												<td class="col-md-1 col-xs-1">
 													<a href='view-student-form&id=<?= $STUDENT_ID ?>' class='btn btn-primary' title='View Form' target="_blank" style="width:100%">View Form</a>

 													<a href='view-student-idcard&id=<?= $STUDENT_ID ?>' class='btn btn-primary' title='View ID Card' target="_blank" style="width:100%">View ID Card</a>
