				   ...
				   <?php
					...
					<tr>
						...
						<?php if($IS_DYNAMIC==1){ ?>
						 ...
						 <a href="page.php?page=add-dynamic-page&page_id=<?php echo $PAGE_ID ; ?>" class="btn btn-xs btn-primary">View Dynamic Fields</a>
						...
						<?php if($db->permission('delete_page')){ ?>
							...
							<a href="page.php?page=<?= $deleteLink ?>" onclick="return confirm('Are you sure? ');" class="btn btn-xs btn-danger">Delete</a>
