 				...
 				<div class="box box-primary">
					...
					';
							...
							?>
 										...
 										<tr>
 											<td colspan="3">
 												<a href="update-dynamic-page&page_id=<?= $PAGE_ID ?>&blockno=<?= $BLOCK_NO ?>" class="btn btn-primary">Edit</a>
 												<a href="add-dynamic-page&page_id=<?= $page_id ?>&blockno=<?= $BLOCK_NO ?>&action=delete" onclick="return confirm('Are you sure?')" class="btn btn-danger">Delete</a>
 											</td>
 										</tr>
 										<?php
											echo '</table><br>';
