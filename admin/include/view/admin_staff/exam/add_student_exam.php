...

{
	...
	$header('location:page.php?page=->test(isset($_POST['student_id'])?$_POST['student_id']:'');
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Register For New Exam</li>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Register For New Exam</h3>
