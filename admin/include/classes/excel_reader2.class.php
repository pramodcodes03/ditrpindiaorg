 ...
 * Maintained at https://code.google.com/p/php-excel-reader/

 *

 * Format parsing and MUCH more contributed by:

 *    Matt Roxburgh < https://www.roxburgh.me.uk >
 ...
 *   https://code.google.com/p/php-excel-reader/wiki/ChangeHistory
 ...
 *   https://groups.google.com/group/php-excel-reader-discuss/topics
 ...
 * Based on the Java version by Andy Khan (https://www.andykhan.com).  Now
 ...
 * @link	   https://pear.php.net/package/Spreadsheet_Excel_Reader
...
// https://uk.php.net/manual/en/function.getdate.php
...
class Spreadsheet_Excel_Reader {
	...
	function _format_value($format,$num,$f) {
		...
		// https://code.google.com/p/php-excel-reader/issues/detail?id=7
...
//						$bgcolor = ($bgi & 0x3f80) >> 7;
	...
	function _parsesheet($spos) {
			...
			switch ($code) {
				...
				case SPREADSHEET_EXCEL_READER_TYPE_FORMULA2:
					...
					if ((ord($data[$spos+6])==0) && (ord($data[$spos+12])==255) && (ord($data[$spos+13])==255)) {
						...
						// https://code.google.com/p/php-excel-reader/issues/detail?id=4
		...
		function _getCellDetails($spos,$numValue,$column) {
			...
			if ($type == 'date') {
				...
				// See https://groups.google.com/group/php-excel-reader-discuss/browse_frm/thread/9c3f9790d12d8e10/f2045c2369ac79de
	...
	function _GetIEEE754($rknum) {
		...
		if (($rknum & 0x02) != 0) {
			...
			// https://research.microsoft.com/~hollasch/cgindex/coding/ieeefloat.html
