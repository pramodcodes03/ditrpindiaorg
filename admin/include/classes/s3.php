...
class S3
{
	...
	*
	* https://docs.amazonwebservices.com/AmazonCloudFront/latest/APIReference/ListInvalidation.html
	...
	*
	* https://docs.amazonwebservices.com/AmazonCloudFront/latest/APIReference/index.html?PutConfig.html
	*
	...
	*/
	private static function __getCloudFrontDistributionConfigXML($bucket, $enabled, $comment, $callerReference = '0', $cnames = array(), $defaultRootObject = null, $originAccessIdentity = null, $trustedSigners = array())
	{
		...
		$distributionConfig->setAttribute('xmlns', 'https://cloudfront.amazonaws.com/doc/2010-11-01/');
	...
	*
	* See https://docs.amazonwebservices.com/AmazonCloudFront/latest/APIReference/index.html?GetDistribution.html
	*
...
final class S3Request
{
	...
	*/
	public function getResponse()
	{
		...
		$url = (S3::$useSSL ? 'https://' : 'https://') . ($this->headers['Host'] !== '' ? $this->headers['Host'] : $this->endpoint) . $this->uri;
		// Basic setup
		$curl = curl_init();
