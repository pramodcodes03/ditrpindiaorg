                        ...
                        <div class="col-md-12 col-sm-8">
                            <div id="login">
                                ...
                                <div class="form-group">
                                    <input name="code" pattern="[a-zA-Z0-9]+" maxlength="20" type="text" value="<?= isset($_POST['code']) ? $_POST['code'] : '' ?>" style="padding: 10px;
                                font-size: 20px;">
                                </div>

                                <div class="">
                                    <input type="submit" name="verify_student" class="btn btn-primary" value="Verify" />
                                    <a href="<?= HTTP_HOST ?>/certificate-verify" class="btn btn-danger">Cancel</a>
   ...
   ">
    ...
    width: 50%;"> Course Name </h2>
                                        <div class="columns">
                                            <ul class="price">
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;"><?= $COURSE_NAME ?><?= $COURSE_NAME_MULTI_SUB ?><?php if ($TYPING_COURSE_ID != '' && $TYPING_COURSE_ID != 0) {
                                                                                                                                                            echo $COURSE_NAME_TYPING;
                                                                                                                                                        } ?></h4>
                                                </li>
    ...
    width: 50%;"> Course Details </h2>
                                        <div class="columns">
                                            <ul class="price">
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Certificate Number : <?= $CERTIFICATE_NO ?> </h4>
                                                </li>
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Course Duration : <?= $course_duration ?><?= $course_duration_multisub ?><?= $course_duration_typing ?></h4>
                                                </li>
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Certificate Issue : <?= $ISSUE_DATE_F ?> </h4>
                                                </li>
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Certificate Period : <?= $start_course_date ?> To <?= $end_course_date ?> </h4>
                                                </li>
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Marks Obtained : <?= $MARKS_PER ?> % </h4>
                                                </li>
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Grade Secured : <?= $GRADE ?> </h4>
                                                </li>
    ...
    width: 50%;">Institute Details </h3>
                                            <ul class="price">
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Name Of Institute : <br /><br /><?= $INSTITUTE_NAME ?> </h4>
                                                </li>
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Institute Email : <br /><br /><?= $institute_email ?> </h4>
                                                </li>
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Institute Contact :<br /><br /> <?= $institutemobile ?> </h4>
                                                </li>
                                                <li class="header">
                                                    <h4 class="course-value" style="font-size: 15px;">Institute Address : <br /><br /><?= $instituteaddress ?> </h4>
                                                </li>
